...
const comicSpecialProkopenkoGromAtSunrise = {
    y_func: (layoutsNodes, comicId) => {
        const previousAndNextComicsY = [comicMajorIgorGromBook.y, comicMajorIgorGromSingle.y];
...
const comicWinterSpecialPlagueDoctor = {
    y_func: (layoutsNodes, comicId) => {
        const previousAndNextComicsY = [comicPlagueDoctorBook.y, comicPlagueDoctorSingle.y];
...
const positions = {
    ...
    comic_major_grom_1939                    : {
        y_func: (layoutsNodes, comicId) => {
            const previousAndNextComicsY = [comicMajorGromBook.y, comicMajorGromSingle.y];
    ...
    comic_major_grom_and_red_fury_volume_7   : {
        x_func: (layoutsNodes, comicId) => {
            const containedComicsX = [
                "comic_time_of_raven_prologue", "comic_time_of_raven_1", "comic_major_grom_38", "comic_time_of_raven_2",
                "comic_major_grom_39", "comic_time_of_raven_3", "comic_major_grom_40", "comic_time_of_raven_4",
                "comic_major_grom_41", "comic_time_of_raven_5"
            ]
        ...
        y     : comicMajorGromBook.y
    },
    comic_major_grom_like_in_war             : comicMajorGromLikeInWarBook,
...
[
    ...
    "comic_rivers_there_is_no_fear", "comic_witch_hunt"
]
    .forEach((key) => {
...
[
    ...
    "comic_rubinstein_what_i_was_looking_for", "comic_witch_hunt_finale", "comic_witch_hunt_prologue"
]
    .forEach((key) => {
        positions[key] = comicIgorGromSingle;
    });

[
    "comic_major_grom_volume_1", "comic_major_grom_volume_2", "comic_major_grom_volume_3", "comic_major_grom_volume_4",
    "comic_major_grom_volume_5", "comic_major_grom_volume_6", "comic_major_grom_volume_8"
]
    .forEach((key) => {
...
[
    ...
    .forEach((key) => {
        positions[key] = comicMajorGromSingle;
    });
...
[
    ...
    .forEach((key) => {
        positions[key] = comicMajorGromLikeInWarSingle;
    });
...
export default {
    ...
    //                                      : range_besoboy, comic_black_dog_its_time_2
    //      : range_besoboy, comic_black_dog_its_time_3                                      : range_besoboy,
    ...
    //                                        : range_bubble_triptych, comic_bubble_triptych_2
    //                : range_bubble_triptych, comic_bubble_triptych_3                                         :
    // range_bubble_triptych, comic_butterfly_catcher                                         : comicPlagueDoctorBook,
    ...
    //                                        : comic_caesar_magnificent_book, comic_caesar_magnificent_1
    //                        : comic_caesar_magnificent, comic_caesar_magnificent_2
    //   : comic_caesar_magnificent, comic_caesar_magnificent_3                                      :
    ...
    //                                        : comic_community, comic_community_2
    //          : comic_community, comic_community_3                                               : comic_community,
    // comic_community_4                                               : comic_community,
    // comic_community_plush_and_dangerous_storybook_electronic        : comic_community,
    // comic_community_plush_and_dangerous_storybook_printed           : comic_community_book, comic_crusade
    //                                        : {y: range_planeswalkers.y + difference.y}, comic_crusade_1
    //                                    : range_planeswalkers, comic_crusade_2
    //          : range_planeswalkers, comic_crusade_3                                                 :
    // range_planeswalkers, comic_crusade_4                                                 : range_planeswalkers,
    // comic_crusade_epilogue                                          : range_planeswalkers, comic_crusade_prologue
    //                                       : range_planeswalkers, comic_crusade_wolf
    //             : comic_crusade_wolf_book, comic_crusade_wolf_1                                            :
    // comic_crusade_wolf, comic_crusade_wolf_2                                            : comic_crusade_wolf,
    // comic_crusade_wolf_3                                            : comic_crusade_wolf, comic_crusade_wolf_4
    //                                      : comic_crusade_wolf, comic_crusade_wolf_5
    //           : comic_crusade_wolf, comic_devilry                                                   : {y:
    // range_bubble_legends.y + difference.y}, comic_devilry_1                                                 :
    // range_bubble_legends, comic_devilry_2                                                 : range_bubble_legends,
    // comic_devilry_3                                                 : range_bubble_legends, comic_devilry_4
    ...
    // comic_fiction_novel_fury                                        : comic_fiction_novel,
    ...
    //                                       : {y: range_friends_comics.y + difference.y}, comic_friends_comics_1
    //                                    : range_friends_comics, comic_friends_comics_2
    //           : range_friends_comics, comic_friends_comics_3                                          :
    ...
    //                                        : range_friends_comics, comic_friends_comics_7
    //               : range_friends_comics, comic_friends_comics_8                                          :
    // range_friends_comics, comic_friends_comics_9                                          : range_friends_comics,
    // comic_friends_comics_10                                         : range_friends_comics, comic_friends_comics_11
    //                                        : range_friends_comics, comic_friends_comics_12
    //               : range_friends_comics, comic_friends_comics_13                                         :
    // range_friends_comics, comic_friends_comics_14                                         : range_friends_comics,
    // comic_friends_comics_15                                         : range_friends_comics, comic_friends_comics_16
    //                                        : range_friends_comics, comic_friends_comics_17
    //               : range_friends_comics, comic_friends_comics_18                                         :
    // range_friends_comics, comic_friends_comics_19                                         : range_friends_comics,
    // comic_friends_comics_20                                         : range_friends_comics, comic_friends_comics_21
    //                                        : range_friends_comics, comic_friends_comics_22
    //               : range_friends_comics, comic_friends_comics_23                                         :
    ...
    //                                        : range_friends_comics, comic_friends_comics_27
    //               : range_friends_comics, comic_gray_hound_volume_1_chapter_1                             :
    // range_bubble_manga_line_2, comic_heroes_and_monsters                                       : {y:
    // (comicMajorIgorGromSingle.y + comicPlagueDoctorSingle.y + difference.y) / 2}, comic_hourly_time_against
    //                              : range_besoboy_book, comic_igor_grom_book_1
    //   : comicIgorGromHardcoverBook,
    //   comic_igor_grom_book_2                                          : comicIgorGromHardcoverBook,
    ...
    // range_bubble_manga_line_2_book, comic_major_igor_grom_volume_1                                  :
    // comicMajorIgorGromBook, comic_major_igor_grom_volume_2                                  :
    // comicMajorIgorGromBook,  comic_major_grom_promise                                        : comicIgorGromSingle,
    // comic_major_grom_stories                                        : {y: (comicMajorGromSingle.y +
    // comicMajorIgorGromSingle.y) / 2 + difference.y}, comic_major_grom_volume_8  : comicMajorGromBook,
    ...
    // comic_plague_doctor_volume_1                                    : comicPlagueDoctorBook,
    // comic_plague_doctor_volume_2                                    : comicPlagueDoctorBook,
    // comic_plague_doctor_volume_3                                    : { x_func: (layoutsNodes, comicId) => { return
    // (layoutsNodes["node_plague_doctor_9"].x + layoutsNodes["node_plague_doctor_10"].x) / 2; }, y     :
    // comicPlagueDoctorBook.y }, comic_planeswalkers_15                                          :
    // comicWitchHuntSingle, comic_planeswalkers_book_1                                      :
    // range_planeswalkers_hardcover_book, comic_planeswalkers_book_2                                      :
    // range_planeswalkers_hardcover_book, comic_plush_policeman_perfect_plan                              :
    ...
    // comic_soyuzmultcomics : range_childrens_comics, comic_special_prokopenko_grom_at_sunrise
    // : comicSpecialProkopenkoGromAtSunrise, comic_tagar_volume_1                                            :
    ...
    // comic_teo_crop_circles_1                                        : range_meteora, comic_teo_crop_circles_2 :
    // range_meteora, comic_teo_crop_circles_3 : range_meteora, comic_teo_crop_circles_4
    //         : range_meteora, comic_turbocarp                                                 : range_turbocarp,
    // comic_unicorn_conspiracy_volume_1                               : comic_unicorn_conspiracy,
    // comic_unicorn_conspiracy_volume_2                               : comic_unicorn_conspiracy, comic_vera_wolf
    //                                            : range_bubble_legends,
    ...
    // comic_ziggy_space_hamster_5                                     : range_childrens_comics, difference,
    // range_allies, range_besoboy, range_besoboy_vol_2, range_bubble_school, range_exlibrium,
    // range_exlibrium_second_life, range_bubble_gam, range_igor_grom                                                 :
    // comicIgorGromSingle, range_major_grom                                                : comicMajorGromSingle,
    // range_major_igor_grom                                           : comicMajorIgorGromSingle, range_meteora,
    // range_mir, range_monk, range_plague_doctor                                             :
    // comicPlagueDoctorSingle, range_planeswalkers, range_red_fury, range_thief_of_shadows, range_witch
};