...
export const layouts: vNG.Layouts = {
    nodes: {
        ...
        node_inok_i_mayor_grom_tome: {x: x_difference * 64, y: y_inok_single}, // {x: x_difference * 38,
        ...
        node_vremya_vorona_single_prolog: {x: x_difference * 43, y: y_vremya_vorona_single},
        ...
        node_vremya_vorona_single_1: {x: x_difference * 44, y: y_vremya_vorona_single},
        node_besoboy_single_38: {x: x_difference * 44, y: y_besoboy_single},
        node_mayor_grom_single_38: {x: x_difference * 45, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_inok_single_38: {x: x_difference * 45, y: y_inok_single},
        node_krasnaya_furiya_single_38: {x: x_difference * 46, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_ekslibrium_single_14: {x: x_difference * 46, y: y_ekslibrium_single},
        node_meteora_single_14: {x: x_difference * 46, y: y_meteora_single},
        node_vremya_vorona_single_2: {x: x_difference * 46, y: y_vremya_vorona_single},
        node_besoboy_single_39: {x: x_difference * 46, y: y_besoboy_single},
        node_ziggi_single_2: {x: x_difference * 46, y: y_ziggi_single},
        node_mayor_grom_single_39: {x: x_difference * 47, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_koshki_myshki_tome_1: {x: x_difference * 47, y: y_koshki_myshki_tome},
        node_inok_single_39: {x: x_difference * 47, y: y_inok_single},
        node_krasnaya_furiya_single_39: {x: x_difference * 48, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_ekslibrium_single_15: {x: x_difference * 48, y: y_ekslibrium_single},
        node_meteora_single_15: {x: x_difference * 48, y: y_meteora_single},
        node_vremya_vorona_single_3: {x: x_difference * 48, y: y_vremya_vorona_single},
        node_tsezar_velikolepnyy_single_1: {x: x_difference * 48, y: y_tsezar_velikolepnyy_single},
        node_besoboy_single_40: {x: x_difference * 48, y: y_besoboy_single},
        node_inok_single_40: {x: x_difference * 49, y: y_inok_single},
        node_mayor_grom_single_40: {x: x_difference * 49, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_tsezar_velikolepnyy_single_2: {x: x_difference * 49, y: y_tsezar_velikolepnyy_single},
        node_krasnaya_furiya_single_40: {x: x_difference * 50, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_ekslibrium_single_16: {x: x_difference * 50, y: y_ekslibrium_single},
        node_meteora_single_16: {x: x_difference * 50, y: y_meteora_single},
        node_vremya_vorona_single_4: {x: x_difference * 50, y: y_vremya_vorona_single},
        node_besoboy_single_41: {x: x_difference * 50, y: y_besoboy_single},
        node_tsezar_velikolepnyy_single_3: {x: x_difference * 50, y: y_tsezar_velikolepnyy_single},
        node_krasnaya_furiya_single_41: {x: x_difference * 51, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_inok_single_41: {x: x_difference * 51, y: y_inok_single},
        node_tsezar_velikolepnyy_single_4: {x: x_difference * 51, y: y_tsezar_velikolepnyy_single},
        node_mayor_grom_single_41: {x: x_difference * 52, y: y_mayor_grom_i_krasnaya_furiya_single},
        node_ekslibrium_single_17: {x: x_difference * 52, y: y_ekslibrium_single},
        node_meteora_single_17: {x: x_difference * 52, y: y_meteora_single},
        node_vremya_vorona_single_5: {x: x_difference * 52, y: y_vremya_vorona_single},
        node_ziggi_single_3: {x: x_difference * 52, y: y_ziggi_single},
        ...
        node_tsezar_velikolepnyy_single_5: {x: x_difference * 52, y: y_tsezar_velikolepnyy_single},
        node_vremya_vorona_tome_epilog: {x: x_difference * 53, y: y_vremya_vorona_tome},
        node_krasnaya_furiya_single_42: {x: x_difference * 53, y: y_krasnaya_furiya_single},
        node_besoboy_single_42: {x: x_difference * 53, y: y_besoboy_single},
        node_inok_korol_vecherinok_single: {x: x_difference * 53, y: y_inok_korol_vecherinok_single},
        node_mayor_grom_single_42: {x: x_difference * 54, y: y_mayor_grom_single},
        node_inok_single_42: {x: x_difference * 54, y: y_inok_single},
        node_ekslibrium_single_18: {x: x_difference * 54, y: y_ekslibrium_single},
        ...
        node_meteora_single_18: {x: x_difference * 54, y: y_meteora_single},
        node_besoboy_single_43: {x: x_difference * 54, y: y_besoboy_single},
        node_mayor_grom_single_43: {x: x_difference * 55, y: y_mayor_grom_single},
        node_inok_single_43: {x: x_difference * 55, y: y_inok_single},
        node_krasnaya_furiya_single_43: {x: x_difference * 55, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_19: {x: x_difference * 55, y: y_ekslibrium_single},
        node_meteora_single_19: {x: x_difference * 55, y: y_meteora_single},
        node_besoboy_single_44: {x: x_difference * 55, y: y_besoboy_single},
        node_mayor_grom_single_44: {x: x_difference * 56, y: y_mayor_grom_single},
        node_inok_single_44: {x: x_difference * 56, y: y_inok_single},
        node_krasnaya_furiya_single_44: {x: x_difference * 56, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_20: {x: x_difference * 56, y: y_ekslibrium_single},
        node_meteora_single_20: {x: x_difference * 56, y: y_meteora_single},
        node_besoboy_single_45: {x: x_difference * 56, y: y_besoboy_single},
        node_mayor_grom_single_45: {x: x_difference * 57, y: y_mayor_grom_single},
        ...
        node_inok_single_45: {x: x_difference * 57, y: y_inok_single},
        node_ziggi_single_4: {x: x_difference * 57, y: y_ziggi_single},
        node_ziggi_single_5: {x: x_difference * 58, y: y_ziggi_single},
        node_krasnaya_furiya_tome_6: {x: x_difference * 41, y: y_krasnaya_furiya_tome}, /* 32 - 37 */
        node_krasnaya_furiya_single_45: {x: x_difference * 58, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_21: {x: x_difference * 58, y: y_ekslibrium_single},
        node_meteora_single_21: {x: x_difference * 58, y: y_meteora_single},
        node_besoboy_single_46: {x: x_difference * 58, y: y_besoboy_single},
        node_mayor_grom_single_46: {x: x_difference * 58, y: y_mayor_grom_single},
        node_inok_single_46: {x: x_difference * 58, y: y_inok_single},
        node_krasnaya_furiya_single_46: {x: x_difference * 59, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_22: {x: x_difference * 59, y: y_ekslibrium_single},
        node_meteora_single_22: {x: x_difference * 59, y: y_meteora_single},
        node_tsezar_velikolepnyy_tome: {x: x_difference * 50, y: y_tsezar_velikolepnyy_tome}, /* 1 - 5 */
        node_besoboy_single_47: {x: x_difference * 59, y: y_besoboy_single},
        node_mayor_grom_single_47: {x: x_difference * 59, y: y_mayor_grom_single},
        node_inok_tome_6: {x: x_difference * 41.5, y: y_inok_tome}, /* 32 - 38 */
        node_inok_single_47: {x: x_difference * 59, y: y_inok_single},
        node_krasnaya_furiya_single_47: {x: x_difference * 60, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_23: {x: x_difference * 60, y: y_ekslibrium_single},
        node_besoboy_tome_7: {x: x_difference * 48.5, y: y_besoboy_tome},                                           /* 38 - 42 */
        node_mayor_grom_i_krasnaya_furiya_tome_7: {x: x_difference * 48.5, y: y_mayor_grom_i_krasnaya_furiya_tome}, /* mg_38, kf_38, mg_39, kf_39, mg_40, kf_40, kf_41, mg_41 */
        node_inok_tome_7: {x: x_difference * 50.5, y: y_inok_tome},                                                 /* 39 - 42 */
        node_meteora_single_23: {x: x_difference * 60, y: y_meteora_single},
        node_besoboy_single_48: {x: x_difference * 60, y: y_besoboy_single},
        node_mayor_grom_single_48: {x: x_difference * 60, y: y_mayor_grom_single},
        node_ekslibrium_tome_3: {x: x_difference * 46.5, y: y_ekslibrium_tome},     /* 11 - 17 */
        node_meteora_tome_3: {x: x_difference * 48, y: y_meteora_tome},             /* 13 - 17 */
        node_vremya_vorona_tome: {x: x_difference * 47.5, y: y_vremya_vorona_tome}, /* 0 - 5 */
        node_koshki_myshki_tome_2: {x: x_difference * 60, y: y_koshki_myshki_tome},
        node_inok_single_48: {x: x_difference * 60, y: y_inok_single},
        node_krasnaya_furiya_single_48: {x: x_difference * 61, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_24: {x: x_difference * 61, y: y_ekslibrium_single},
        node_meteora_single_24: {x: x_difference * 61, y: y_meteora_single},
        node_besoboy_single_49: {x: x_difference * 61, y: y_besoboy_single},
        node_mayor_grom_single_49: {x: x_difference * 61, y: y_mayor_grom_single},
        node_inok_single_49: {x: x_difference * 61, y: y_inok_single},
        node_krasnaya_furiya_single_49: {x: x_difference * 62, y: y_krasnaya_furiya_single},
        node_ekslibrium_single_25: {x: x_difference * 62, y: y_ekslibrium_single},
        node_meteora_single_25: {x: x_difference * 62, y: y_meteora_single},
        node_besoboy_tome_8: {x: x_difference * 56, y: y_besoboy_tome}, /* 43 - 46 */
        node_ekslibrium_single_26: {x: x_difference * 63, y: y_ekslibrium_single},
        node_besoboy_single_50: {x: x_difference * 63, y: y_besoboy_single},
        node_mayor_grom_single_50: {x: x_difference * 63, y: y_mayor_grom_single},
        node_inok_single_50: {x: x_difference * 63, y: y_inok_single},
        node_krasnaya_furiya_single_50: {x: x_difference * 63, y: y_krasnaya_furiya_single},
        node_meteora_single_26: {x: x_difference * 63, y: y_meteora_single},
        node_krasnaya_furiya_tome_8: {x: x_difference * 55.5, y: y_krasnaya_furiya_tome}, /* 42 - 45 */
        node_ziggi_tome: {x: x_difference * 50.5, y: y_ziggi_tome},                       /* 1 - 5 */
        node_tochka_nevozvrata_tome: {x: x_difference * 63, y: y_tochka_nevozvrata_tome},
        node_besoboy_vol_2_1_single_1: {x: x_difference * 64, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_1: {x: x_difference * 64, y: y_igor_grom_single},
        node_mirokhodtsy_single_1: {x: x_difference * 64, y: y_mirokhodtsy_single},
        node_soyuzniki_single_1: {x: x_difference * 64, y: y_soyuzniki_single},
        node_ekslibrium_single_27: {x: x_difference * 64, y: y_ekslibrium_single},
        node_meteora_single_27: {x: x_difference * 64, y: y_meteora_single},
        node_soyuzniki_single_2: {x: x_difference * 65, y: y_soyuzniki_single},
        node_besoboy_vol_2_1_single_2: {x: x_difference * 65, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_2: {x: x_difference * 65, y: y_igor_grom_single},
        node_mirokhodtsy_single_2: {x: x_difference * 65, y: y_mirokhodtsy_single},
        node_mayor_grom_single_shans: {x: x_difference * 65, y: y_mayor_grom_single},
        node_ekslibrium_single_28: {x: x_difference * 65, y: y_ekslibrium_single},
        node_meteora_single_28: {x: x_difference * 65, y: y_meteora_single},
        node_soyuzniki_single_3: {x: x_difference * 66, y: y_soyuzniki_single},
        node_besoboy_vol_2_1_single_3: {x: x_difference * 66, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_3: {x: x_difference * 66, y: y_igor_grom_single},
        node_mirokhodtsy_single_3: {x: x_difference * 66, y: y_mirokhodtsy_single},
        node_ekslibrium_single_29: {x: x_difference * 66, y: y_ekslibrium_single},
        node_meteora_single_29: {x: x_difference * 66, y: y_meteora_single},
        node_soyuzniki_single_4: {x: x_difference * 67, y: y_soyuzniki_single},
        node_igor_ugor_tome_1: {x: x_difference * 67, y: y_igor_ugor_tome},
        node_besoboy_vol_2_1_single_4: {x: x_difference * 67, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_4: {x: x_difference * 67, y: y_igor_grom_single},
        node_mirokhodtsy_single_4: {x: x_difference * 67, y: y_mirokhodtsy_single},
        node_ekslibrium_single_30: {x: x_difference * 67, y: y_ekslibrium_single},
        node_meteora_single_30: {x: x_difference * 67, y: y_meteora_single},
        node_soyuzniki_single_5: {x: x_difference * 68, y: y_soyuzniki_single},
        node_besoboy_vol_2_1_single_5: {x: x_difference * 68, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_5: {x: x_difference * 68, y: y_igor_grom_single},
        node_besoboy_tome_9: {x: x_difference * 61, y: y_besoboy_tome}, /* 47 - 50 */
        node_mirokhodtsy_single_5: {x: x_difference * 68, y: y_mirokhodtsy_single},
        node_ekslibrium_single_31: {x: x_difference * 68, y: y_ekslibrium_single},
        node_meteora_single_31: {x: x_difference * 68, y: y_meteora_single},
        node_soyuzniki_single_6: {x: x_difference * 69, y: y_soyuzniki_single},
        node_mayor_grom_tome_8: {x: x_difference * 58.5, y: y_mayor_grom_tome}, /* 42 - 50 */
        node_inok_tome_8: {x: x_difference * 59, y: y_inok_tome},               /* 43 - 50 */
        node_besoboy_vol_2_1_single_6: {x: x_difference * 69, y: y_besoboy_vol_2_1_single},
        node_igor_grom_single_6: {x: x_difference * 69, y: y_igor_grom_single},
        node_krasnaya_furiya_tome_9: {x: x_difference * 61, y: y_krasnaya_furiya_tome}, /* 46 - 50 */
        node_mirokhodtsy_single_6: {x: x_difference * 69, y: y_mirokhodtsy_single},
        node_ekslibrium_single_32: {x: x_difference * 69, y: y_ekslibrium_single},
        node_meteora_single_32: {x: x_difference * 69, y: y_meteora_single},
