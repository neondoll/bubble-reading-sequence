...
const comics: Comics = {
    ...
    comic_major_grom_and_red_fury_volume_7                                  : {
        ...
        characters      : ["character_arthur_huxley", "character_delta", "character_dmitry_dubin", "character_gamma", "character_helga_lemke", "character_igor_grom", "character_joshua_donato", "character_kirk_oreilly", "character_lotta_lemke", "character_murdoch_mcallister", "character_nika_chaikina", "character_richard_rippe"],
        authors         : [{author_id: "author_artyom_gabrelyanov", positions: ["screenwriter"]},
                           {author_id: "author_anna_rud", positions: ["artist"]},
                           {author_id: "author_kirill_perepelitsyn", positions: ["colorist"]},
                           {author_id: "author_margarita_kablukova", positions: ["colorist"]},
