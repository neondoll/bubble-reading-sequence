...
const comics: Comics = {
    ...
    comic_major_grom_tome_5                                                 : {
        ...
        ranges          : ["range_major_grom"],
        characters      : ["character_dmitry_dubin", "character_fedor_prokopenko", "character_igor_grom",
                           "character_oleg_volkov", "character_plague_doctor", "character_yulia_pchyolkina"],
        authors         : ["author_anastasia_kim", "author_artyom_gabrelyanov", "author_margarita_kablukova",
                           "author_nina_vakueva", "author_tatiana_yakubets"],
    ...
    comic_major_grom_and_red_fury_tome_7                                    : {
        ...
        characters      : ["character_arthur_huxley", "character_delta", "character_dmitry_dubin", "character_gamma",
                           "character_helga_lemke", "character_igor_grom", "character_joshua_donato",
                           "character_kirk_oreilly", "character_lotta_lemke", "character_murdoch_mcallister",
                           "character_nika_chaikina", "character_richard_rippe"],
        authors         : ["author_anna_rud", "author_artyom_gabrelyanov", "author_kirill_perepelitsyn",
    ...
    comic_fiction_novel_major_grom                                          : {
        ...
        ranges    : ["range_major_grom"],
        characters: ["character_dmitry_dubin", "character_igor_grom", "character_yulia_pchyolkina"],
        authors   : ["author_alexey_volkov", "author_andrey_vasin"],
        release_at: {year: 2021, month: 12, day: 18}
    },
    ...
    comic_brother_25_years                                                  : {
        name      : "Брат. 25 лет",
        type      : "book",
        ranges    : ["range_evgeny_fedotov", "range_alexey_zamsky", "range_vitaly_terletsky"],
    ...
    comic_the_ink_prince_and_the_book_knight                                : {
        ...
        type            : "book",
        ranges          : ["range_bubble_manga"],
        contained_comics: ["comic_the_ink_prince_and_the_book_knight_1", "comic_the_ink_prince_and_the_book_knight_2",
                           "comic_the_ink_prince_and_the_book_knight_3", "comic_the_ink_prince_and_the_book_knight_4"],
        release_at      : {year: 2022, month: 10, day: 24}
    },
    ...
    comic_major_grom_riddle_of_the_sphinx                                   : {
        ...
        authors         : ["author_anna_sidorova", "author_eduard_petrovich", "author_roman_kotkov",
