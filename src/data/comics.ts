...
export const comics: Comics = {
    ...
    comic_exlibrium_tome_9                           : {
        ...
        next_comics     : ["comic_exlibrium_blank_sheet_book"],
        release_at      : {year: 2019, month: 10, day: 3}
    },
