...
export const nodes: Record<string, Node> = {
    ...
    node_krasnaya_furiya_tome_1966: {name: "Красная Фурия:\n1966", color: colors.krasnaya_furiya, size: sizes.tome},
