...
const ranges: Ranges = {
    ...
    range_point_of_no_return   : {name: "Точка невозврата", release_at: {year: 2016, month: 12, day: 24}},
    ...
    range_ziggy_and_shmyg      : {name: "Зигги и Шмыг", release_at: {year: 2018, month: 4, day: 1}},
    range_evgeny_yakovlev      : {name: "Евгений Яковлев", release_at: {year: 2018, month: 8, day: 11}},
    range_anastasia_kim        : {name: "Анастасия Ким", release_at: {year: 2018, month: 10}},
    range_new_bubble_heroes    : {name: "Новые герои BUBBLE", release_at: {year: 2019, month: 4, day: 21}},
