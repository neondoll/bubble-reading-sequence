        ...
        <v-data-table hide-default-footer :headers="headers" :items="items" :loading="loading">
            <template v-if="!loading" v-slot:body.append>
                <tr>
                    ...
                    <td><b>{{ realization_cost_full }}</b></td>
                    <td><b>{{ kap_coast_full }}</b></td>
                    <td><b>{{ finansee_sum }}</b></td>
                    <td v-if="isChange"/>
                </tr>
            </template>
            <template v-slot:header.begin_date="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.final_date="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.finansee="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.index="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.is_nessesary="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.kap_coast="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.name="{ header }"><b>{{ header.text }}</b></template>
            <template v-slot:header.realization_cost="{ header }"><b>{{ header.text }}</b></template>
            ...
            <template v-slot:item.is_nessesary="{ item }">{{ item.is_nessesary ? 'Да' : 'Нет' }}</template>
            <template v-slot:item.begin_date="{ item }">{{ getDate(item.begin_date) }}</template>
            <template v-slot:item.final_date="{ item }">{{ getDate(item.final_date) }}</template>
            ...
            <template v-slot:top>
                <v-toolbar flat>
                    <v-toolbar-title>Сведения о планируемых мероприятиях</v-toolbar-title>
