<template>
    <v-card>
        <v-data-table :headers="headers" :items="items" :loading="loading">
            <template v-slot:header.goal="{ header }">
                <span class="font-inter-normal-700" style="color: #1B202B;">{{ header.text }}</span>
            </template>
            <template v-slot:header.indicator="{ header }">
                <span class="font-inter-normal-700" style="color: #1B202B;">{{ header.text }}</span>
            </template>
            ...
            <template v-slot:item.goal="{ item }">
                <span class="font-inter-normal-400" style="color: #1B202B;">{{ item.goal }}</span>
            </template>
            <template v-slot:item.indicator="{ item }">
                <span class="font-inter-normal-400" style="color: #1B202B;">{{ item.indicator }}</span>
            </template>
            <template v-slot:item.unit="{ item }">
                <span class="font-inter-normal-400" style="color: #1B202B;">{{ item.unit }}</span>
            </template>
            <template v-slot:top>
                <v-toolbar flat>
