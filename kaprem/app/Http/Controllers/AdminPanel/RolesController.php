...
class RolesController
{
    ...
    {
        return View::make('admin_panel.roles.index', [
    ...
    public function show(Request $request, $id): \Illuminate\Contracts\View\View
    {
        ...
        return View::make('admin_panel.roles.show', ['role' => $role]);
    }
    ...
    public function edit($id): \Illuminate\Contracts\View\View|RedirectResponse
    {
        $role = $this->rolesModel::query()
            ->with('permissions:id')
            ->findOrFail($id);
