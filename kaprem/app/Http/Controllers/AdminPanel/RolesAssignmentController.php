...
{
    protected mixed $rolesModel;
    protected mixed $permissionModel;
    protected mixed $assignPermissions;
    ...
    public function index(Request $request): \Illuminate\Contracts\View\View
    {
        ...
        return View::make('admin_panel.roles-assignment.index', [
            'models' => $modelsKeys,
            'modelKey' => $modelKey,
    ...
    public function edit(
        Request $request,
        $modelId
    ): \Illuminate\Contracts\View\View|Redirector|RedirectResponse|Application {
        ...
        return View::make('admin_panel.roles-assignment.edit', [
            'modelKey' => $modelKey,
            'roles' => $roles,
