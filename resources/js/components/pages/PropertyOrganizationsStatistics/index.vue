<template>
    <n-page label="Статистика" :breadcrumbs="breadcrumbs" :style="`height: ${height}px;`">
...
export default {
    ...
    data: () => ({
        breadcrumbs: [
            ...
            {text: 'Имущество подведомственных организаций', disabled: true},
            {text: 'Статистика', disabled: true}
        ],
